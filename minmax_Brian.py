...
def main():
    ...
    print(f"Nombre total de parties gagnées par 'X' : {wins_for_x}, soit {int((wins_for_x / total_games) * 100)}%")
    print(f"Nombre total de parties gagnées par 'O' : {wins_for_o}, soit {int((wins_for_o / total_games) * 100)}%")
    print(f"Nombre total de parties nulles : {draw}, soit {int((draw / total_games) * 100)}%")
